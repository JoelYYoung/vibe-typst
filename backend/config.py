...
# The file opened on first launch (until the user opens a project via the UI).
# Defaults to the bundled sample deck; override with TYPST_FILE env var.
DEFAULT_FILE = Path(
    os.environ.get("TYPST_FILE", str(_HERE / "sample" / "welcome.typ"))
).expanduser()
